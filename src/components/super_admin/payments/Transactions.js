...
import {
  TransactionsListStorageDispatcher,
  TransactionsListStorageResponseReset,
} from "../../actions/payment_module/TransactionsListStorage";
import Pagination from "../Pagination";
import { withTranslation } from "react-i18next";
import { useHistory } from "react-router";

const SATransactions = ({t}) => {
            ...
            <div class="relative flex items-center justify-between h-16">
              <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                >
                  <div
                    class={`rounded-full text-sm px-3 py-1 ${
                      activeReceivedFilter ? "bg-blue-500 text-white" : ""
                    }`}
                  >
                    {t("received")}
                  </div>
                ...
                >
                  <div
                    class={`rounded-full text-sm px-3 py-1 ${
                      activeSentFilter ? "bg-blue-500 text-white" : ""
                    }`}
                  >
                    {t("sent")}
                  </div>
                            ...
                            <p class="text-gray-900 whitespace-no-wrap">
                              {item.mode == "subscription" ? (
                                ...
                                <span class="relative inline-block px-3 py-1 font-semibold text-blue-900 leading-tight">
                                  ...
                                  ></span>
                                  <span class="relative">{t("case")}</span>
                                </span>
                              )}
                            </p>
                          </td>
...
export default withTranslation()(SATransactions);
