...
import {
  EmployeeCaseListStorageDispatcher,
  EmployeeCaseListStorageResponseReset,
} from "../../actions/case_management/EmployeeCasesListStorage";
import { withTranslation } from "react-i18next";
import { useHistory } from "react-router";

const EmployeeCases = ({ t }) => {
                            ...
                            <div class="flex items-center">
                              <div class="ml-3">
                                <p class="text-blue-700 ">
                                  <Link to={`/user/case/${item._id.$oid}`}>
                                    {item.title}
                                  </Link>
                                </p>
                              </div>
...
export default withTranslation()(EmployeeCases);
