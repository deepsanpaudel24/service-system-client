...
import { ChildAccountListStorageDispatcher, ChildAccountListStorageResponseReset } from "../../actions/people_mangement/ChildAccountListStorage";

const ChildAccounts = (props) => {
    ...
    const response2 = useSelector(state => state.ChildAccountListStorageResponse)
    ...
    useLayoutEffect(() => {
        ...
        .then((res) => {
                ...
                dispatch(ChildAccountListStorageDispatcher({[page]: res.data['employees'], 'total_records': res.data['total_records']}))
        })
        .catch((error) => {
