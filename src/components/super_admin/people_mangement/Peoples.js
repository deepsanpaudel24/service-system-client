...
import {
  DeactivatePeopleDispatcher,
  DeactivatePeopleResponseReset,
} from "../../actions/people_mangement/DeactivatePeopleAction";
import Pagination from "../Pagination";
import {
  PeoplesListStorageDispatcher,
  PeoplesListStorageResponseReset,
} from "../../actions/people_mangement/PeopleListStorage";
...
const Peoples = ({ t }) => {
  ...
  const ActivationStatusPopUp = (email, id) => {
    confirmAlert({
      customUI: ({ onClose }) => {
        return (
          <div className="bg-white shadow border rounded px-4 py-4 mx-auto max-w-lg">
            <h1 class="text-3xl text-red-600 px-4">{t("activate_acc")}</h1>
            <hr class="border-gray-300 my-4" />
            <div class="px-4">
              <div
                class="flex items-center bg-orange-100 text-black px-4 py-3 mb-3"
              ...
              >
                <div class="flex">
                  ...
                  <div>
                    <p class="font-bold text-md text-gray-800">
                      {t("activate_account_warning")}
                    </p>
                    <p class="text-sm text-gray-800">
                      {t("activate_account_info")}
                    </p>
                  </div>
                </div>
              </div>
  ...
  const handleAdd = () => {
    ...
    return history.push("/sadmin/people/add");
  };
            ...
            <div class="relative flex items-center justify-between h-16">
              <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                >
                  <div
                    class={`rounded-full text-sm px-3 py-1 ${
                      activeCCAFilter ? "bg-blue-500 text-white" : ""
                    }`}
                  >
                    {t("client_admin")}
                  </div>
                ...
                >
                  <div
                    class={`rounded-full text-sm px-3 py-1 ${
                      activeSPCAFilter ? "bg-blue-500 text-white" : ""
                    }`}
                  >
                    {t("sp_admin")}
                  </div>
