...
const PeopleCases = (props) => {
    ...
    const response2 = useSelector(state => state.SAPeopleCaseListStorageResponse)
    ...
    useLayoutEffect(() => {
        ...
        .then((res) => {
                ...
                dispatch(SAPeopleCaseListStorageDispatcher({[page]: res.data['cases'], 'total_records': res.data['total_records']}))
        })
        .catch((error) => {
