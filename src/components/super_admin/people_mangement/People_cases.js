...
import { SAPeopleCaseListStorageDispatcher } from "../../actions/case_management/SuperAdminPeopleCaseListStorageDispatcher";
...
const PeopleCases = ({ t }) => {
  ...
  const response2 = useSelector(
    (state) => state.SAPeopleCaseListStorageResponse
  );
  ...
  useLayoutEffect(() => {
    ...
    const config = {
      method: "get",
      url: "/api/v1/people/cases/" + urlvalues[3] + "/" + page,
      headers: {
    ...
    axios(config)
      .then((res) => {
        ...
        dispatch(
          SAPeopleCaseListStorageDispatcher({
            [page]: res.data["cases"],
  ...
  const handlePageChange = (value) => {
    ...
    const config = {
      method: "post",
      url: "/api/v1/people/cases/" + urlvalues[3] + "/" + value,
      data: {
    ...
    if (response2.data.hasOwnProperty(value)) {
      ...
      axios(config)
        .then((res) => {
          ...
          dispatch(SAPeopleCaseListStorageDispatcher(reduxResponse));
        })
        .catch((error) => {
          console.log(error.response);
        });
  ...
  const SortingRequest = (value) => {
    ...
    const config = {
      method: "post",
      url: "/api/v1/people/cases/" + urlvalues[3] + "/" + defaultPage,
      data: {
        keyword: searchKeyword,
        filters: filters,
        sorting: value,
                            ...
                            <div class="flex items-center">
                              <div class="ml-3">
                                <Link to={`/sadmin/case/${item._id.$oid}`}>
                                  <p class="text-blue-700 ">{item.title}</p>
                                </Link>
                              </div>
                            </div>
                          </td>
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm" style={{maxWidth: '12em'}}>
                            {
                                ...
                                <span
                                    ...
                                    <span class="relative">{t("proposal_forwarded")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span class="relative">{t("waiting_contract_paper")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-indigo-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("contract_paper_sent")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-indigo-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("signed_contract_paper_sent")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-indigo-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("awaiting_advance_installment")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("completion_requested")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("awaiting_final_installment")}</span>
                                </span>
                                :
                                ...
                                <span
                                    ...
                                    <span aria-hidden
                                        class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                                    <span class="relative">{t("final_payment_received")}</span>
                                </span>
                                :
                                item.status == "Closed" ?
                                <span
...
export default withTranslation()(PeopleCases);
