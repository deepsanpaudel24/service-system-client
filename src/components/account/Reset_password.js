            ...
            <div class="container mx-auto w-full max-w-sm py-4">
                <form>
                    <div class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
                        {showServerError()}
                        {showMessage()}
                        <p class="text-3xl my-3" style={{textAlign: "center"}}>Reset Password</p>
                        <div class="mb-6">
                            ...
                            </label>
                            {
                                password == "" && passwordError == "" ?
                                    <div>
                                        <p class="text-gray-500 text-xs italic">Hint: To comply with our Strong Password policy, you are required to use a sufficiently strong password. Password must be more than 7 characters.</p>
                                        <input 
