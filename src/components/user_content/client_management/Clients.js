...
import { ClientListStorageDispatcher, ClientListStorageResponseReset } from "../../actions/client_management/ClientListStorage";
    ...
    useLayoutEffect(() => {
        ...
        if(response2.data.hasOwnProperty(1)){
            ...
            .then((res) => {
                    ...
                    dispatch(ClientListStorageDispatcher({[page]: res.data['clients'], 'total_records': res.data['total_records']}))
            })
            .catch((error) => {
