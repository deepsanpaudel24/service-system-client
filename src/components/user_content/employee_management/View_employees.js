...
import {
  ...
  EmployeesListStorageResponseReset,
} from "../../actions/employee_management/EmployeesListStorage";
...
const ViewEmployees = (props) => {
      ...
      customUI: ({ onClose }) => {
        return (
          <div className="bg-white shadow border rounded px-4 py-4 mx-auto max-w-lg">
            <h1 class="text-3xl text-red-600 px-4">{t("delete_employee")}</h1>
            ...
            <div class="px-4">
                ...
                <div class="flex">
                  ...
                  <div>
                    <p class="font-bold text-md text-gray-800">
                      {t("delete_employee_account")}
                    </p>
                    <p class="text-sm text-gray-800">
                      {t("delete_emp_warning")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div>
                  <p class="text-sm text-gray-900">{t("delete_emp_info")} </p>
  ...
  const handleAdd = () => {
    dispatch(AddEmployeeResponseReset());{t("")}
    return history.push("/user/add-employee");
  };
                          ...
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            {item.is_verified ? (
                              ...
                              <span class="relative inline-block px-3 py-1 font-semibold text-red-900 leading-tight">
                                ...
                                ></span>
                                <span class="relative">{t("unverfied")}</span>
                              </span>
                            )}
                          </td>
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
...
export default withTranslation()(ViewEmployees);
