...
import {
  ...
  ClientCaseListStorageResponseReset,
} from "../../actions/case_management/ClientCasesListStorage";
...
const ViewCasesSP = (props) => {
  ...
  const SortingRequest = (value) => {
    ...
    const config = {
      method: "post",
      url: "/api/v1/cases-sp/" + defaultPage,
      data: {
        keyword: searchKeyword,
        filters: filters,
        sorting: value,
                        ...
                        <tr>
                            ...
                            {item.status == "Requested" ? (
                              ...
                              <span class="relative inline-block px-3 py-1 font-semibold text-blue-900 leading-tight">
                                <span
                                  ...
                                  class="absolute inset-0 bg-blue-300 opacity-50 rounded-full"
                                ></span>
                                <span class="relative">{t("received")}</span>
                              </span>
                              ...
                              <span class="relative inline-block px-3 py-1 font-semibold text-indigo-900 leading-tight">
                                ...
                                ></span>
                                <span class="relative">
                                  {t("signed_contract_paper_received")}
                                </span>
                              </span>
                              ...
                              <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                ...
                                ></span>
                                <span class="relative">
                                  {t("platform_received_final_payment")}
                                </span>
                              </span>
                            ) : item.status == "Closed" ? (
                              <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                          ...
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-blue-700 whitespace-no-wrap">
                              ...
                              {item.status == "Forwarded" ? (
                                <Link to={`/user/case/reply/${item._id.$oid}`}>
                                  {" "}
                                  | {t("make_proposal")}
                                </Link>
                              ) : (
...
export default withTranslation()(ViewCasesSP);
